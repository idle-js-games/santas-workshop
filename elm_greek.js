...
Elm.Santa.make = function (_elm) {
   ...
   $Santa$Controller$Controller.UpdateDeliveries,
   $Time.delay(500 * $Time.millisecond)($Time.fps(1)));
   var updateProductionSignal = A2($Signal._op["<~"],
   $Santa$Controller$Controller.UpdateProduction,
   $Time.fps(1));
   var setPurchaseMultiplierSignal = function () {
      var selectMultiplier = F2(function (ctrlDown,
      shiftDown) {
         return ctrlDown && shiftDown ? $Santa$Controller$Controller.SetPurchaseMultiplier(100) : ctrlDown ? $Santa$Controller$Controller.SetPurchaseMultiplier(25) : shiftDown ? $Santa$Controller$Controller.SetPurchaseMultiplier(10) : $Santa$Controller$Controller.SetPurchaseMultiplier(1);
      });
   ...
   var state = function () {
      var signals = _L.fromArray([$Santa$Controller$Controller.actionSignal
...
Elm.Santa = Elm.Santa || {};
Elm.Santa.Common = Elm.Santa.Common || {};
Elm.Santa.Common.make = function (_elm) {
   "use strict";
   _elm.Santa = _elm.Santa || {};
   _elm.Santa.Common = _elm.Santa.Common || {};
   if (_elm.Santa.Common.values)
...
Elm.Santa.Controller.Controller = Elm.Santa.Controller.Controller || {};
Elm.Santa.Controller.Controller.make = function (_elm) {
   "use strict";
   _elm.Santa = _elm.Santa || {};
   _elm.Santa.Controller = _elm.Santa.Controller || {};
   _elm.Santa.Controller.Controller = _elm.Santa.Controller.Controller || {};
   if (_elm.Santa.Controller.Controller.values)
   ...
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Santa.Controller.Controller",
   $Basics = Elm.Basics.make(_elm),
   ...
   state) {
      return function () {
         var state$ = _U.replace([["notifications"
                                  ,_L.fromArray([])]],
         state);
         var state$$ = function () {
            switch (action.ctor)
            {case "Create":
               return function () {
                    ...
                    return _U.replace([["products"
                                       ,A3($Santa$Model$Stackable.update,
                                       action._0,
                                       amount,
                                       state$.products)]],
                    state$);
               ...
               case "Deliver":
               return A2($Santa$Model$State.deliverWrapped,
                 1,
                 state$);
               case "NoOp": return state$;
               case "Produce": return state$;
               case "Purchase":
               return A3($Santa$Model$State.purchaseProducer,
                 action._0,
                 action._1,
                 state$);
               case "Research":
               ...
               return A2($Santa$Model$State.updateDeliveries,
                 action._0,
                 state$);
               case "UpdateProduction":
               return A2($Santa$Model$State.updateProduction,
                 action._0,
                 state$);
               case "UpdateResearch":
               return A2($Santa$Model$State.updateResearch,
                 action._0,
                 state$);
               case "Wrap":
               return _U.replace([["products"
                                  ,A3($Santa$Model$Product.wrap,
                                  action._0,
                                  1,
                                  state$.products)]],
                 state$);}
   ...
   var Research = function (a) {
      return {ctor: "Ερεύνησε"
             ,_0: a};
   };
   ...
   var Deliver = {ctor: "Παράδωσε"};
   var Wrap = function (a) {
      return {ctor: "Τύλιξε",_0: a};
   };
   ...
   var Create = function (a) {
      return {ctor: "Δημιούργησε"
             ,_0: a};
   };
   var UpdateResearch = function (a) {
      return {ctor: "UpdateResearch"
             ,_0: a};
   };
...
Elm.Santa.Model.Producer = Elm.Santa.Model.Producer || {};
Elm.Santa.Model.Producer.make = function (_elm) {
   "use strict";
   _elm.Santa = _elm.Santa || {};
   _elm.Santa.Model = _elm.Santa.Model || {};
   _elm.Santa.Model.Producer = _elm.Santa.Model.Producer || {};
   if (_elm.Santa.Model.Producer.values)
   ...
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Santa.Model.Producer",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Santa$Common = Elm.Santa.Common.make(_elm),
   $Santa$Model$Product = Elm.Santa.Model.Product.make(_elm),
   ...
   products) {
      return function () {
         var deliverAmount = function ($function) {
            return function () {
         ...
         var w = A2($Santa$Model$Stackable.count,
         $Santa$Model$Product.wrapped,
         products);
         var step = F2(function (_v2,c) {
            return function () {
               switch (_v2.ctor)
               {case "_Tuple2":
                  return w - A2($Basics.max,
                    0,
                    w - c - _v2._0 * _v2._1);}
               _U.badCase($moduleName,
               "on line 53, column 30 to 62");
            }();
         });
            ...
            return function () {
               ...
               {case "_Tuple2":
                  return {ctor: "_Tuple2"
                         ...
                         ,_1: _v6._1};}
               _U.badCase($moduleName,
               "on line 59, column 42 to 88");
            }();
         },
         producers));
      }();
   });
   var produce$ = F4(function (amount,
   power,
   $function,
   products) {
      return function () {
            ...
            return A3($List.foldr,
              F2(function (_v14,ps) {
                 return function () {
                    switch (_v14.ctor)
                    {case "_Tuple2":
                       return A3($Santa$Model$Stackable.update,
                         _v14._0,
                         $Basics.round($Basics.toFloat(_v14._1) * $Basics.toFloat(amount) * power),
                         ps);}
                    _U.badCase($moduleName,
                    "on line 36, column 44 to 110");
                 }();
              }),
              products,
              $function._0);
            ...
            return function () {
                 ...
                 function (_v18) {
                    return function () {
                       switch (_v18.ctor)
                       {case "_Tuple2":
                          return A2($Santa$Model$Stackable.count,
                            _v18._0,
                            products) / _v18._1 | 0;}
                       _U.badCase($moduleName,
                       "on line 38, column 56 to 88");
                    }();
                 },
                 $function._0));
                 var multiplier = A2($Basics.min,
                 $Basics.toFloat(amount),
                 $Basics.toFloat(possible));
                 var updateConsumers = function (xs) {
                    ...
                    function (_v22) {
                       return function () {
                          switch (_v22.ctor)
                          {case "_Tuple2":
                             return A2($Santa$Model$Stackable.update,
                               _v22._0,
                               $Basics.round($Basics.toFloat(_v22._1) * multiplier));}
                          _U.badCase($moduleName,
                          "on line 40, column 56 to 105");
                       }();
                    },
                    xs,
                    $function._1);
                    ...
                    function (_v26) {
                       return function () {
                          ...
                          {case "_Tuple2":
                             return A2($Santa$Model$Stackable.update,
                               _v26._0,
                               0 - $Basics.round($Basics.toFloat(_v26._1) * multiplier * power));}
                          _U.badCase($moduleName,
                          "on line 41, column 56 to 116");
                       }();
                    },
                    xs,
                    $function._0);
   ...
   products) {
      return function () {
         ...
         {case "_Tuple2":
            return A3($List.foldr,
              A2(produce$,_v30._1,power),
              products,
              _v30._0.function);}
         _U.badCase($moduleName,
         "on line 48, column 5 to 61");
      }();
   });
   ...
   x) {
      return function () {
         var calc = function (n) {
            return n + (Math.pow(A2($Basics.max,
            1,
            n / 4 | 0) * x,
            2) / 2 | 0);
         };
   ...
   5,
   $Santa$Model$Product.spirit)]))($Santa$Common.Named("Τάρανδος")($Basics.identity({_: {}}))));
   var airplane = Functional(_L.fromArray([Deliverer(10)]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                                              ...
                                                                                                              ,A2($Santa$Model$Stackable.stack,
                                                                                                              10,
                                                                                                              $Santa$Model$Product.spirit)]))($Santa$Common.Named("Αεροπλάνο")($Basics.identity({_: {}}))));
   ...
   var woodenToyMaker = Functional(_L.fromArray([A2(Transformer,
   _L.fromArray([A2($Santa$Model$Stackable.stack,
   3,
   $Santa$Model$Product.wood)]),
   _L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
   $Santa$Model$Product.woodenToy)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
   10,
   $Santa$Model$Product.wood)]))($Santa$Common.Named("Κατασκευαστής ξύλινου παιχνιδιού")($Basics.identity({_: {}}))));
   var metalCarFactory = Functional(_L.fromArray([A2(Transformer,
   _L.fromArray([A2($Santa$Model$Stackable.stack,
   3,
   $Santa$Model$Product.metal)]),
   _L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
   $Santa$Model$Product.metalCar)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
   10,
   $Santa$Model$Product.metal)]))($Santa$Common.Named("Εργοστάσιο για Παιχνίδια Αμαξάκια")($Basics.identity({_: {}}))));
   var plasticFactory = Functional(_L.fromArray([A2(Transformer,
   _L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
   $Santa$Model$Product.oil)]),
   _L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
   $Santa$Model$Product.plastic)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                         5,
                                                                                         $Santa$Model$Product.metal)
                                                                                         ,A2($Santa$Model$Stackable.stack,
                                                                                         5,
                                                                                         $Santa$Model$Product.oil)]))($Santa$Common.Named("Διυλιστήριο πετρελαίου")($Basics.identity({_: {}}))));
   var batteryFactory = Functional(_L.fromArray([A2(Transformer,
   _L.fromArray([A2($Santa$Model$Stackable.stack,
                1,
                $Santa$Model$Product.metal)
                ,A2($Santa$Model$Stackable.stack,
   ...
   _L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
   $Santa$Model$Product.battery)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                         10,
                                                                                         $Santa$Model$Product.metal)
                                                                                         ,A2($Santa$Model$Stackable.stack,
                                                                                         10,
                                                                                         $Santa$Model$Product.oil)]))($Santa$Common.Named("Κατασκευαστής Μπαταρίας")($Basics.identity({_: {}}))));
   var microchipFactory = Functional(_L.fromArray([A2(Transformer,
   _L.fromArray([A2($Santa$Model$Stackable.stack,
                1,
                $Santa$Model$Product.metal)
                ,A2($Santa$Model$Stackable.stack,
                1,
                $Santa$Model$Product.spirit)]),
   _L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
   $Santa$Model$Product.microchip)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                           20,
                                                                                           $Santa$Model$Product.metal)
                                                                                           ,A2($Santa$Model$Stackable.stack,
                                                                                           20,
                                                                                           $Santa$Model$Product.oil)]))($Santa$Common.Named("Κατασκευαστής Microchip")($Basics.identity({_: {}}))));
   var legoFactory = Functional(_L.fromArray([A2(Transformer,
   _L.fromArray([A2($Santa$Model$Stackable.stack,
   3,
   $Santa$Model$Product.plastic)]),
   _L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
   $Santa$Model$Product.legos)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                       10,
                                                                                       $Santa$Model$Product.metal)
                                                                                       ,A2($Santa$Model$Stackable.stack,
                                                                                       10,
                                                                                       $Santa$Model$Product.oil)]))($Santa$Common.Named("Εργοστάσιο Lego")($Basics.identity({_: {}}))));
   var rcCarFactory = Functional(_L.fromArray([A2(Transformer,
   _L.fromArray([A2($Santa$Model$Stackable.stack,
                3,
                $Santa$Model$Product.plastic)
                ,A2($Santa$Model$Stackable.stack,
                1,
                $Santa$Model$Product.battery)]),
   _L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
   $Santa$Model$Product.rcCar)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                       30,
                                                                                       $Santa$Model$Product.metal)
                                                                                       ,A2($Santa$Model$Stackable.stack,
                                                                                       10,
                                                                                       $Santa$Model$Product.oil)]))($Santa$Common.Named("Εργοστάσιο RC αυτοκινήτου")($Basics.identity({_: {}}))));
   var computerFactory = Functional(_L.fromArray([A2(Transformer,
   _L.fromArray([A2($Santa$Model$Stackable.stack,
                3,
                $Santa$Model$Product.plastic)
                ,A2($Santa$Model$Stackable.stack,
                3,
                $Santa$Model$Product.microchip)]),
   _L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
   $Santa$Model$Product.computer)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                          50,
                                                                                          $Santa$Model$Product.metal)
                                                                                          ,A2($Santa$Model$Stackable.stack,
                                                                                          30,
                                                                                          $Santa$Model$Product.oil)]))($Santa$Common.Named("Κατασκευαστής PC")($Basics.identity({_: {}}))));
   var gameConsoleFactory = Functional(_L.fromArray([A2(Transformer,
   _L.fromArray([A2($Santa$Model$Stackable.stack,
                3,
                $Santa$Model$Product.plastic)
                ,A2($Santa$Model$Stackable.stack,
   ...
   _L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
   $Santa$Model$Product.gameConsole)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                             50,
                                                                                             $Santa$Model$Product.metal)
                                                                                             ,A2($Santa$Model$Stackable.stack,
                                                                                             30,
                                                                                             $Santa$Model$Product.oil)]))($Santa$Common.Named("Κατασκευαστής Παιχνιδομηχανών")($Basics.identity({_: {}}))));
   var paperFactory = Functional(_L.fromArray([A2(Transformer,
   _L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
   $Santa$Model$Product.wood)]),
   _L.fromArray([A2($Santa$Model$Stackable.stack,
   5,
   $Santa$Model$Product.wrappingPaper)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                               10,
                                                                                               $Santa$Model$Product.wood)
                                                                                               ,A2($Santa$Model$Stackable.stack,
                                                                                               10,
                                                                                               $Santa$Model$Product.metal)]))($Santa$Common.Named("Εργοστάσιο Χαρτιού")($Basics.identity({_: {}}))));
   var toyWrapper = Functional(_L.fromArray([A2(Transformer,
                                            _L.fromArray([A2($Santa$Model$Stackable.stack,
                                                         1,
                                                         $Santa$Model$Product.woodenToy)
                                                         ,A2($Santa$Model$Stackable.stack,
                                                         1,
                                                         $Santa$Model$Product.wrappingPaper)]),
                                            _L.fromArray([A2($Santa$Model$Stackable.stack,
                                            1,
                                            $Santa$Model$Product.wrapped)]))
                                            ,A2(Transformer,
   ...
   3,
   $Santa$Model$Product.spirit)]))($Santa$Common.Named("Περιτύλιγμα απλού παιχνιδιού")($Basics.identity({_: {}}))));
   var advancedToyWrapper = Functional(_L.fromArray([A2(Transformer,
                                                    _L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                 1,
                                                                 $Santa$Model$Product.legos)
                                                                 ,A2($Santa$Model$Stackable.stack,
                                                                 1,
                                                                 $Santa$Model$Product.wrappingPaper)]),
                                                    _L.fromArray([A2($Santa$Model$Stackable.stack,
                                                    ...
                                                    $Santa$Model$Product.wrapped)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
   3,
   $Santa$Model$Product.spirit)]))($Santa$Common.Named("Περιτύλιγμα παιχνιδιού σε κουτί")($Basics.identity({_: {}}))));
   var highTechToyWrapper = Functional(_L.fromArray([A2(Transformer,
                                                    _L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                 1,
                                                                 $Santa$Model$Product.computer)
                                                                 ,A2($Santa$Model$Stackable.stack,
                                                                 1,
                                                                 $Santa$Model$Product.wrappingPaper)]),
                                                    _L.fromArray([A2($Santa$Model$Stackable.stack,
                                                    ...
                                                    _L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                 1,
                                                                 $Santa$Model$Product.gameConsole)
                                                                 ,A2($Santa$Model$Stackable.stack,
                                                                 1,
                                                                 $Santa$Model$Product.wrappingPaper)]),
                                                    _L.fromArray([A2($Santa$Model$Stackable.stack,
                                                    ...
                                                    $Santa$Model$Product.wrapped)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
   3,
   $Santa$Model$Product.spirit)]))($Santa$Common.Named("Περιτύλιγμα Προϊόντων High-Tech")($Basics.identity({_: {}}))));
   var Creator = function (a) {
      return {ctor: "Creator"
             ,_0: a};
   };
   var lumberjack = Functional(_L.fromArray([Creator(_L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
   $Santa$Model$Product.wood)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
   $Santa$Model$Product.spirit)]))($Santa$Common.Named("Ξυλοκόπος")($Basics.identity({_: {}}))));
   var miner = Functional(_L.fromArray([Creator(_L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
   $Santa$Model$Product.metal)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
   $Santa$Model$Product.spirit)]))($Santa$Common.Named("Μεταλλωρύχος")($Basics.identity({_: {}}))));
   var oilRig = Functional(_L.fromArray([Creator(_L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
   $Santa$Model$Product.oil)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                     10,
                                                                                     $Santa$Model$Product.wood)
                                                                                     ,A2($Santa$Model$Stackable.stack,
                                                                                     10,
                                                                                     ...
                                                                                     ,A2($Santa$Model$Stackable.stack,
                                                                                     1,
                                                                                     $Santa$Model$Product.spirit)]))($Santa$Common.Named("Εξέδρα άντλησης πετρελαίου")($Basics.identity({_: {}}))));
   var santasLittleHelper = Functional(_L.fromArray([Creator(_L.fromArray([A2($Santa$Model$Stackable.stack,
   1,
...
Elm.Santa = Elm.Santa || {};
Elm.Santa.Model = Elm.Santa.Model || {};
Elm.Santa.Model.Product = Elm.Santa.Model.Product || {};
Elm.Santa.Model.Product.make = function (_elm) {
   "use strict";
   _elm.Santa = _elm.Santa || {};
   _elm.Santa.Model = _elm.Santa.Model || {};
   _elm.Santa.Model.Product = _elm.Santa.Model.Product || {};
   if (_elm.Santa.Model.Product.values)
   ...
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Santa.Model.Product",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Santa$Common = Elm.Santa.Common.make(_elm),
   $Santa$Model$Stackable = Elm.Santa.Model.Stackable.make(_elm);
   var wrappable = {_: {}
                   ,wrappable: true
                   ,wrapped: false};
   var woodenToy = $Santa$Common.Named("Ξύλινο Παιχνίδι")(wrappable);
   var metalCar = $Santa$Common.Named("Αμάξι Παιχνίδι")(wrappable);
   var legos = $Santa$Common.Named("Lego Σετ")(wrappable);
   var rcCar = $Santa$Common.Named("RC Αμάξι")(wrappable);
   ...
   var consumable = {_: {}
                    ,wrappable: false
                    ,wrapped: false};
   var wrapped = $Santa$Common.Named("Τυλιγμένο Δώρο")(_U.replace([["wrapped"
                                                                    ,true]],
   consumable));
   var spirit = $Santa$Common.Named("Πνεύμα Χριστουγέννων")(consumable);
   var wood = $Santa$Common.Named("Ξύλο")(consumable);
   var metal = $Santa$Common.Named("Μέταλλο")(consumable);
   var oil = $Santa$Common.Named("Πετρέλαιο")(consumable);
   var basics = _L.fromArray([wood
                             ,metal
                             ,oil]);
   var wrappingPaper = $Santa$Common.Named("Χαρτί περιτυλίγματος")(consumable);
   var battery = $Santa$Common.Named("Μπαταρία")(consumable);
   var plastic = $Santa$Common.Named("Πλαστικό")(consumable);
   var microchip = $Santa$Common.Named("Microchip")(consumable);
            ...
            case true: return function () {
                 var updates = _L.fromArray([{ctor: "_Tuple2"
                                            ...
                                            ,{ctor: "_Tuple2"
                                             ,_0: wrapped
                                             ,_1: amount}]);
                 var remaining = A2($Santa$Model$Stackable.count,
                 product,
                 products);
                 return _U.cmp(remaining - amount,
                 0) > -1 ? A3($List.foldr,
                 $Basics.uncurry($Santa$Model$Stackable.update),
                 products,
                 updates) : products;
              }();}
         _U.badCase($moduleName,
         "between lines 13 and 20");
      }();
   });
   _elm.Santa.Model.Product.values = {_op: _op
                                     ,wrap: wrap
...
Elm.Santa = Elm.Santa || {};
Elm.Santa.Model = Elm.Santa.Model || {};
Elm.Santa.Model.Purchasable = Elm.Santa.Model.Purchasable || {};
Elm.Santa.Model.Purchasable.make = function (_elm) {
   "use strict";
   _elm.Santa = _elm.Santa || {};
   _elm.Santa.Model = _elm.Santa.Model || {};
   _elm.Santa.Model.Purchasable = _elm.Santa.Model.Purchasable || {};
   if (_elm.Santa.Model.Purchasable.values)
   return _elm.Santa.Model.Purchasable.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Santa.Model.Purchasable",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Santa$Common = Elm.Santa.Common.make(_elm),
   $Santa$Model$Product = Elm.Santa.Model.Product.make(_elm),
         ...
         return function () {
            ...
            {case "_Tuple2":
               return _U.cmp(A2($Santa$Model$Stackable.count,
                 ...
                 _v0._1) > -1;}
            _U.badCase($moduleName,
            "on line 24, column 22 to 54");
         }();
      },
      cost);
   });
   var purchase = F5(function (cost,
   purchasableItem,
   amount,
   items,
   products) {
      return function () {
         var item = _U.remove("cost",
         purchasableItem);
         var totalCost = A3(cost,
         purchasableItem,
         A2($Santa$Model$Stackable.count,
         item,
         items),
         amount);
         return A2(canAfford,
         ...
         products) ? function () {
            var products$ = $Santa$Model$Stackable.combine(products)(A2($List.map,
            function (_v4) {
               return function () {
                  switch (_v4.ctor)
                  {case "_Tuple2":
                     return {ctor: "_Tuple2"
                            ...
                            ,_1: 0 - _v4._1};}
                  _U.badCase($moduleName,
                  "on line 33, column 80 to 85");
               }();
            },
            totalCost));
            var items$ = A3($Santa$Model$Stackable.update,
            item,
            amount,
            items);
            return {ctor: "_Tuple2"
   ...
   var cost$ = F2(function (purchasableItem,
   x) {
      return purchasableItem.cost;
   });
   var cost = F3(function (purchasableItem,
   existing,
   amount) {
      return function () {
         var range = _L.range(existing,
   ...
   _elm.Santa.Model.Purchasable.values = {_op: _op
...
Elm.Santa = Elm.Santa || {};
Elm.Santa.Model = Elm.Santa.Model || {};
Elm.Santa.Model.Stackable = Elm.Santa.Model.Stackable || {};
Elm.Santa.Model.Stackable.make = function (_elm) {
   "use strict";
   _elm.Santa = _elm.Santa || {};
   _elm.Santa.Model = _elm.Santa.Model || {};
   _elm.Santa.Model.Stackable = _elm.Santa.Model.Stackable || {};
   if (_elm.Santa.Model.Stackable.values)
   return _elm.Santa.Model.Stackable.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Santa.Model.Stackable",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Santa$Common = Elm.Santa.Common.make(_elm);
   ...
   _elm.Santa.Model.Stackable.values = {_op: _op
                                       ,stack: stack
                                       ,count: count
                                       ,update: update
                                       ,combine: combine};
...
Elm.Santa = Elm.Santa || {};
Elm.Santa.Model = Elm.Santa.Model || {};
Elm.Santa.Model.State = Elm.Santa.Model.State || {};
Elm.Santa.Model.State.make = function (_elm) {
   "use strict";
   _elm.Santa = _elm.Santa || {};
   _elm.Santa.Model = _elm.Santa.Model || {};
   _elm.Santa.Model.State = _elm.Santa.Model.State || {};
   if (_elm.Santa.Model.State.values)
   return _elm.Santa.Model.State.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Santa.Model.State",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Santa$Common = Elm.Santa.Common.make(_elm),
   ...
   $String = Elm.String.make(_elm),
   $Time = Elm.Time.make(_elm);
   var showResearchCompleted = function (unlockables) {
      return A2($List.map,
      function (x) {
         ...
         A2($Basics._op["++"],
         "</b><br/>",
         $String.concat($List.intersperse("<br/>")($Santa$Model$Unlockable.description(x.bonus))))));
      },
      unlockables);
   };
   ...
   state) {
      return function () {
         var spiritsGained = $Basics.round($Basics.toFloat(amount) * $Santa$Model$Unlockable.spiritPower(state.unlockables));
         var deltas = _L.fromArray([{ctor: "_Tuple2"
                                    ,_0: $Santa$Model$Product.wrapped
                                    ,_1: 0 - amount}
                                   ,{ctor: "_Tuple2"
                                    ,_0: $Santa$Model$Product.spirit
                                    ,_1: spiritsGained}]);
         ...
         0) > -1 ? _U.replace([["deliveries"
                               ,target]
                              ,["products"
                               ,A2($Santa$Model$Stackable.combine,
                               state.products,
                               deltas)]],
         state) : state;
      }();
   });
   var researchUnlockable = F2(function (purchasableUnlockable,
   state) {
      return function () {
         var unlockableStack = A2($List.map,
         $Santa$Model$Stackable.stack(1),
         state.unlockables);
         var $ = A5($Santa$Model$Purchasable.purchase,
         $Santa$Model$Purchasable.cost,
         purchasableUnlockable,
         1,
         unlockableStack,
         state.products),
         unlockables = $._0,
         products = $._1;
         var unlockables$ = A2($List.map,
         $Basics.fst,
         unlockables);
         return _U.replace([["unlockables"
                            ,unlockables$]
                           ,["products",products]],
         state);
      }();
   });
   var purchaseProducer = F3(function (purchasableProducer,
   amount,
   state) {
      return function () {
         var $ = A5($Santa$Model$Purchasable.purchase,
         $Santa$Model$Producer.cost,
         purchasableProducer,
         amount,
         state.producers,
         state.products),
         producers = $._0,
         products = $._1;
         return _U.replace([["producers"
                            ,producers]
                           ,["products",products]],
         state);
      }();
   });
   var updateResearch = F2(function (deltaTime,
   state) {
      return function () {
         var dt = deltaTime * $Santa$Model$Unlockable.researchPower(state.unlockables);
         var updatedTimers = A2($List.map,
         function (x) {
            return _U.replace([["progressTimer"
                               ,A2($Basics.max,
                               0,
         ...
         state.unlockables);
         var finished = $List.map($Basics.fst)($List.filter(function (_v0) {
            return function () {
               switch (_v0.ctor)
               {case "_Tuple2":
                  return _U.eq(_v0._0.progressTimer,
                    0) && _U.cmp(_v0._1.progressTimer,
                    0) > 0;}
               _U.badCase($moduleName,
               "on line 109, column 50 to 93");
            }();
         })(A3($List.map2,
         F2(function (v0,v1) {
            return {ctor: "_Tuple2"
         ...
         return _U.replace([["unlockables"
                           ...
                           ,["notifications"
                            ,A2($Basics._op["++"],
                            state.notifications,
                            showResearchCompleted(finished))]],
         state);
      }();
   });
   ...
   state) {
      return function () {
         var delta = A2($Santa$Model$Producer.deliveries,
         state.producers,
         state.products);
   ...
   state) {
      return function () {
         var isUniqueProduct = function (x) {
            return x.wrappable && A2($List.all,
            function (y) {
               return !_U.eq(y.name,x.name);
            },
            state.uniqueProductsProduced);
         };
         var powers = $List.map(A2($Basics.flip,
         $Santa$Model$Unlockable.producerPower,
         state.unlockables))(A2($List.map,
         $Basics.fst,
         state.producers));
         var products = A2($List.foldr,
         $Basics.uncurry($Santa$Model$Producer.produce),
         state.products)(A3($List.map2,
         F2(function (v0,v1) {
            return {ctor: "_Tuple2"
                   ,_0: v0
                   ,_1: v1};
         ...
         state.producers,
         powers));
         var uniqueProductsProduced = $List.filter(isUniqueProduct)(A2($List.map,
         $Basics.fst,
         products));
         return _U.replace([["products"
                            ,products]
   ...
   var producers = function (unlockables) {
      return function () {
         var isUnlocked = function (bonus) {
            return function () {
               switch (bonus.ctor)
               {case "UnlockProducer":
                  return $Maybe.Just(bonus._0);}
               return $Maybe.Nothing;
            }();
         };
         var unlocked = $List.filterMap(isUnlocked)($List.concat($List.map(function (_) {
            return _.bonus;
         })(A2($List.filter,
         function (x) {
            return _U.eq(x.progressTimer,
            0);
         },
         unlockables))));
         var basics = _L.fromArray([]);
         return A2($Basics._op["++"],
         basics,
         unlocked);
      }();
   ...
   var otherAchievements = _L.fromArray([Conditional(_L.fromArray([Condition(function (x) {
                                           return _U.cmp(A2($Santa$Model$Stackable.count,
                                           $Santa$Model$Product.spirit,
                                           x.products),
                                           1) > -1;
                                        })]))($Santa$Common.Descriptive("Obtain a Christmas Spirit.")($Santa$Common.Named("Spirit of Christmas")($Basics.identity({_: {}}))))
                                        ,Conditional(_L.fromArray([Condition(function (x) {
                                           return _U.cmp(A2($Santa$Model$Stackable.count,
                                           $Santa$Model$Product.woodenToy,
                                           x.products),
                                           1) > -1;
                                        })]))($Santa$Common.Descriptive("Produce a Wooden Toy.")($Santa$Common.Named("It\'s the Thought That Counts")($Basics.identity({_: {}}))))
                                        ,Conditional(_L.fromArray([Condition(function (x) {
                                           return _U.cmp(A2($Santa$Model$Stackable.count,
                                           $Santa$Model$Product.computer,
                                           x.products),
                                        ...
                                        ,Conditional(_L.fromArray([Condition(function (x) {
                                           return _U.cmp($List.length(x.uniqueProductsProduced),
                                           4) > -1;
                                        })]))($Santa$Common.Descriptive("Produce 4 different types of presents.")($Santa$Common.Named("Segmentation")($Basics.identity({_: {}}))))
                                        ,Conditional(_L.fromArray([Condition(function (x) {
                                           return _U.cmp($List.length(x.uniqueProductsProduced),
                                           6) > -1;
                                        })]))($Santa$Common.Descriptive("Produce 6 different types of presents.")($Santa$Common.Named("Individualism")($Basics.identity({_: {}}))))]);
   var deliveryAchievements = function () {
      var names = _L.fromArray(["Jingle Bells"
                               ,"Christmas Time Is Here"
                               ,"Winter Wonderland"
                               ,"White Christmas"
                               ,"Santa Clause Is Coming to Town"]);
      var amounts = A2($List.map,
      function (x) {
         return Math.pow(10,x);
      },
      _L.range(1,
      $List.length(names)));
      var deliveryAchievement = F2(function (name,
      amount) {
         return Conditional(_L.fromArray([Condition(function (x) {
            return _U.cmp(x.deliveries,
            amount) > -1;
         })]))($Santa$Common.Descriptive(A2($Basics._op["++"],
         "Deliver a total of ",
         A2($Basics._op["++"],
         $Basics.toString(amount),
         " presents.")))($Santa$Common.Named(name)($Basics.identity({_: {}}))));
      });
      return A2($Basics._op["++"],
      _L.fromArray([Conditional(_L.fromArray([Condition(function (x) {
         return _U.cmp(x.deliveries,
         1) > -1;
      })]))($Santa$Common.Descriptive("Make your first delivery.")($Santa$Common.Named("Merry Christmas!")($Basics.identity({_: {}}))))]),
      A3($List.map2,
      deliveryAchievement,
      names,
      amounts));
   }();
   var dpsAchievements = function () {
      var names = _L.fromArray(["Rudolph the Red-Nosed Reindeer"
      ...
      _L.range(0,
      $List.length(names) - 1));
      var dpsAchievement = F2(function (name,
      amount) {
         return Conditional(_L.fromArray([Condition(function (x) {
            return _U.cmp(x.dps,
            amount) > -1;
         ...
         A2($Basics._op["++"],
         $Basics.toString(amount),
         " deliveries per second.")))($Santa$Common.Named(name)($Basics.identity({_: {}}))));
      });
      return A3($List.map2,
      dpsAchievement,
      names,
   ...
   var achievements = $List.concat(_L.fromArray([deliveryAchievements
                                                ,otherAchievements
                                                ,dpsAchievements]));
   ...
   var Achievements = {ctor: "Επιτεύγματα"};
   var Stats = {ctor: "Stats"};
   var Research = {ctor: "Έρευνα"};
   var Workshop = {ctor: "Εργαστήριο"};
   var defaultStartState = {_: {}
                           ...
                           ,timePlayed: 0
                           ,uniqueProductsProduced: _L.fromArray([])
                           ,unlockables: _L.fromArray([])};
   var devStartState = _U.replace([["products"
                                   ,A2($List.map,
                                   $Santa$Model$Stackable.stack(1000000),
                                   $Santa$Model$Product.basics)]
                                  ,["unlockables"
                                   ,_L.fromArray([$Santa$Model$Unlockable.Upgrade(_L.fromArray([$Santa$Model$Unlockable.ResearchPower(1)]))($Santa$Model$Unlockable.researchable(1 * $Time.second)($Santa$Common.Named("RESEARCH TEST")($Basics.identity({_: {}}))))])]],
   defaultStartState);
   var startState = defaultStartState;
   _elm.Santa.Model.State.values = {_op: _op
                                   ,Workshop: Workshop
                                   ,Research: Research
                                   ,Stats: Stats
                                   ,Achievements: Achievements
                                   ,State: State
                                   ,defaultStartState: defaultStartState
                                   ,devStartState: devStartState
                                   ...
                                   ,researchUnlockable: researchUnlockable
                                   ,deliverWrapped: deliverWrapped
                                   ,showAchievements: showAchievements
                                   ,showResearchCompleted: showResearchCompleted
                                   ,achievements: achievements
                                   ,otherAchievements: otherAchievements
                                   ,deliveryAchievements: deliveryAchievements
                                   ,dpsAchievements: dpsAchievements};
   return _elm.Santa.Model.State.values;
};
Elm.Santa = Elm.Santa || {};
Elm.Santa.Model = Elm.Santa.Model || {};
Elm.Santa.Model.Unlockable = Elm.Santa.Model.Unlockable || {};
Elm.Santa.Model.Unlockable.make = function (_elm) {
   "use strict";
   _elm.Santa = _elm.Santa || {};
   _elm.Santa.Model = _elm.Santa.Model || {};
   _elm.Santa.Model.Unlockable = _elm.Santa.Model.Unlockable || {};
   if (_elm.Santa.Model.Unlockable.values)
   ...
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Santa.Model.Unlockable",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Santa$Common = Elm.Santa.Common.make(_elm),
      ...
      return function () {
         ...
         {case "ProducerPower":
            return $Maybe.Just({ctor: "_Tuple2"
                               ,_0: _U.remove("cost",bonus._0)
                               ,_1: bonus._1});}
         return $Maybe.Nothing;
      }();
   };
   var bonuses = function (unlockables) {
      return $List.concatMap(function (_) {
         return _.bonus;
      })(A2($List.filter,
      function (x) {
         return _U.eq(x.progressTimer,
   ...
   var producerPower = F2(function (producer,
   unlockables) {
      return function () {
         var pp = function (_v3) {
            return function () {
               switch (_v3.ctor)
               {case "_Tuple2":
                  return _U.eq(_v3._0.name,
                    producer.name) ? $Maybe.Just(_v3._1) : $Maybe.Nothing;}
               _U.badCase($moduleName,
               "between lines 136 and 137");
            }();
         };
         return A2($List.foldr,
         F2(function (x,y) {
         ...
         1)($List.filterMap(pp)($List.filterMap(producerPower$)(bonuses(unlockables))));
      }();
   });
   var researchPower$ = function (bonus) {
      return function () {
         switch (bonus.ctor)
         {case "ResearchPower":
            return bonus._0;}
   ...
   var researchPower = function (unlockables) {
      return A2($List.foldr,
      F2(function (x,y) {
         return x + y;
      }),
      1)($List.map(researchPower$)(bonuses(unlockables)));
   };
   var spiritPower$ = function (bonus) {
      return function () {
         switch (bonus.ctor)
         {case "SpiritPower":
            return bonus._0;}
   ...
   var spiritPower = function (unlockables) {
      return A2($List.foldr,
      F2(function (x,y) {
         return x + y;
      }),
      1)($List.map(spiritPower$)(bonuses(unlockables)));
   };
   var clickPower$ = function (bonus) {
      return function () {
         switch (bonus.ctor)
         {case "ClickPower":
            return bonus._0;}
   ...
   var clickPower = function (unlockables) {
      ...
      1)($List.map(clickPower$)(bonuses(unlockables)));
   };
   var formatPct = function (pct) {
      return A2($Basics._op["++"],
      $Basics.toString($Basics.round(pct * 100)),
      "%");
   };
   var description = function (bonuses) {
      return function () {
         var unlockeds = function () {
            var showUnlockeds = function (xs) {
               return $List.isEmpty(xs) ? $Maybe.Nothing : $Maybe.Just(A2($Basics._op["++"],
               "Unlocks ",
               A2($Basics._op["++"],
               $List.foldr1(F2(function (x,y) {
                  return A2($Basics._op["++"],
                  x,
                  A2($Basics._op["++"],", ",y));
               }))(A2($List.map,
            ...
            return showUnlockeds(A2($List.filterMap,
            check,
            bonuses));
         }();
         var unlockedProducers = function () {
            var showProducers = function (xs) {
               return $List.isEmpty(xs) ? $Maybe.Nothing : $Maybe.Just(A2($Basics._op["++"],
               "Σου επιτρέπει να χτίσεις ",
               A2($Basics._op["++"],
               $List.foldr1(F2(function (x,y) {
                  return A2($Basics._op["++"],
                  x,
            ...
            return showProducers(A2($List.filterMap,
            check,
            bonuses));
         }();
         var producerPowers = function () {
            ...
            producerPower$,
            bonuses);
            var products = A2($List.map,
            $Basics.fst,
            ps);
            var totals = A2($List.map,
            function (x) {
               return A2($List.foldr,
               F2(function (x,y) {
                  return x + y;
               ...
               function (_v17) {
                  return function () {
                     switch (_v17.ctor)
                     {case "_Tuple2":
                        return _U.eq(_v17._0.name,
                          x.name) ? _v17._1 : 1;}
                     _U.badCase($moduleName,
                     "on line 49, column 68 to 101");
                  }();
               },
               ps));
            },
         ...
         bonuses) {
            return function () {
               ...
               bonuses));
               return _U.cmp(x,
               0) > 0 ? $Maybe.Just(displayFunction(x)) : $Maybe.Nothing;
            }();
         });
         var powers = A2($List.map,
         function (_v21) {
            return function () {
               switch (_v21.ctor)
               {case "_Tuple2":
                  return A3(formatPower,
                    _v21._0,
                    _v21._1,
                    bonuses);}
               _U.badCase($moduleName,
               "on line 41, column 34 to 57");
            }();
         },
         _L.fromArray([{ctor: "_Tuple2"
                       ...
                       ,_1: function (x) {
                          return A2($Basics._op["++"],
                          "Αυξάνει τους πόρους από τα κλικ κατά ",
                          A2($Basics._op["++"],
                          formatPct(x),
                          "."));
                       }}
                      ,{ctor: "_Tuple2"
                       ...
                       ,_1: function (x) {
                          return A2($Basics._op["++"],
                          "Αυξάνει the amount of spirits gained from deliveries by ",
                          A2($Basics._op["++"],
                          formatPct(x),
                          "."));
                       }}
                      ,{ctor: "_Tuple2"
                       ...
                       ,_1: function (x) {
                          return A2($Basics._op["++"],
                          "Αυξάνει την ταχύτητα έρευνας κατά ",
                          A2($Basics._op["++"],
                          formatPct(x),
                          "."));
                       }}]));
   ...
   var Researchable = F3(function (a,
   b,
   c) {
      return _U.insert("progressMax",
      b,
      _U.insert("progressTimer",a,c));
   });
   var researchable = function (time) {
      return A2(Researchable,
      time,
      time);
   };
   ...
   var UnlockProducer = function (a) {
      return {ctor: "UnlockProducer"
             ,_0: a};
   };
   ...
   var batteryPower = Upgrade(_L.fromArray([UnlockProducer($Santa$Model$Producer.batteryFactory)
                                           ,UnlockProducer($Santa$Model$Producer.rcCarFactory)]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                                                                                    ...
                                                                                                                                                    ,A2($Santa$Model$Stackable.stack,
                                                                                                                                                    10000,
                                                                                                                                                    $Santa$Model$Product.spirit)]))(researchable(1 * $Time.hour)($Santa$Common.Named("Μπαταρία Power")($Basics.identity({_: {}})))));
   var papermaking = Upgrade(_L.fromArray([UnlockProducer($Santa$Model$Producer.paperFactory)
                                          ,UnlockProducer($Santa$Model$Producer.toyWrapper)]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                                                                                 ...
                                                                                                                                                 ,A2($Santa$Model$Stackable.stack,
                                                                                                                                                 20,
                                                                                                                                                 $Santa$Model$Product.metal)]))(researchable(30 * $Time.second)($Santa$Common.Named("Paper-making")($Basics.identity({_: {}})))));
   ...
   5)]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                           ...
                                                           ,A2($Santa$Model$Stackable.stack,
                                                           10000,
                                                           $Santa$Model$Product.spirit)]))(researchable(3 * $Time.hour)($Santa$Common.Named("Υπεράκτιες πλατφόρμες")($Basics.identity({_: {}})))));
   var recycling = Upgrade(_L.fromArray([A2(ProducerPower,
                                        ...
                                        1)]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                                ...
                                                                                                ,A2($Santa$Model$Stackable.stack,
                                                                                                1000,
                                                                                                $Santa$Model$Product.spirit)]))(researchable(30 * $Time.minute)($Santa$Common.Named("Ανακύκλωση")($Basics.identity({_: {}})))));
   var assemblyLine = Upgrade(_L.fromArray([A2(ProducerPower,
                                           ...
                                           1)]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                                   ...
                                                                                                   ,A2($Santa$Model$Stackable.stack,
                                                                                                   10000,
                                                                                                   $Santa$Model$Product.spirit)]))(researchable(3 * $Time.hour)($Santa$Common.Named("Γραμμή παραγωγής")($Basics.identity({_: {}})))));
   var rainForestDeregulation = Upgrade(_L.fromArray([A2(ProducerPower,
   $Santa$Model$Producer.lumberjack,
   5)]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
   1000,
   $Santa$Model$Product.spirit)]))(researchable(3 * $Time.hour)($Santa$Common.Named("Απορύθμιση του τροπικού δάσους")($Basics.identity({_: {}})))));
   var chainsaws = Upgrade(_L.fromArray([A2(ProducerPower,
                                        ...
                                        ,Unlock(rainForestDeregulation)]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                                                             ...
                                                                                                                             ,A2($Santa$Model$Stackable.stack,
                                                                                                                             1000,
                                                                                                                             $Santa$Model$Product.spirit)]))(researchable(30 * $Time.minute)($Santa$Common.Named("Αλυσοπρίονα")($Basics.identity({_: {}})))));
   ...
   5)]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                           ...
                                                           ,A2($Santa$Model$Stackable.stack,
                                                           10000,
                                                           $Santa$Model$Product.spirit)]))(researchable(3 * $Time.hour)($Santa$Common.Named("Πυρηνικά τρυπάνια")($Basics.identity({_: {}})))));
   ...
   var heavyMachinery = Upgrade(_L.fromArray([A2(ProducerPower,
                                             ...
                                             ,Unlock(goldRush)]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                                                    ...
                                                                                                                    ,A2($Santa$Model$Stackable.stack,
                                                                                                                    100,
                                                                                                                    $Santa$Model$Product.spirit)]))(researchable(3 * $Time.minute)($Santa$Common.Named("Βαριά μηχανήματα")($Basics.identity({_: {}})))));
   ...
   var globalPositioningSystem = Upgrade(_L.fromArray([A2(ProducerPower,
                                                      ...
                                                      2)]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                                              ...
                                                                                                              ,A2($Santa$Model$Stackable.stack,
                                                                                                              10000,
                                                                                                              $Santa$Model$Product.spirit)]))(researchable(24 * $Time.hour)($Santa$Common.Named("GPS - Global Positioning System")($Basics.identity({_: {}})))));
   ...
   var woodworking = Upgrade(_L.fromArray([UnlockProducer($Santa$Model$Producer.woodenToyMaker)
                                          ...
                                          ,Unlock(papermaking)]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                                                    ...
                                                                                                                    ,A2($Santa$Model$Stackable.stack,
                                                                                                                    10,
                                                                                                                    $Santa$Model$Product.metal)]))(researchable(10 * $Time.second)($Santa$Common.Named("Woodworking")($Basics.identity({_: {}})))));
   ...
   var availableUnlockables = function (current) {
      return function () {
         var completed = A2($List.filter,
         function (x) {
            return _U.eq(x.progressTimer,
            0);
         },
         current);
         var findUnlockable = function (bonus) {
            return function () {
               switch (bonus.ctor)
               {case "Unlock":
                  return $Maybe.Just(bonus._0);}
         ...
         var available = $List.filterMap(findUnlockable)(A2($List.concatMap,
         function (_) {
            return _.bonus;
         },
         completed));
         var basic = _L.fromArray([forestry
                                  ,mining]);
         return A2($List.filter,
         function (x) {
            return A2($List.all,
            function (y) {
               return !_U.eq(x.name,y.name);
            },
            current);
         },
         A2($Basics._op["++"],
   ...
   _elm.Santa.Model.Unlockable.values = {_op: _op
                                        ...
                                        ,availableUnlockables: availableUnlockables
                                        ,clickPower$: clickPower$
                                        ,spiritPower$: spiritPower$
                                        ,researchPower$: researchPower$
                                        ,bonuses: bonuses
...
Elm.Santa.View.Producer.make = function (_elm) {
         ...
         {case "Creator":
            ...
            return A2($Html.div,
              ...
              _L.fromArray([A2($Html.em,
                           ...
                           ,$Html.div(_L.fromArray([]))(A2($List.map,
                           function (x) {
                              return A2($Html.span,
   ...
   products) {
      return function () {
         ...
         " ",
         A2($Basics._op["++"],
         $Basics.toString(purchaseMultiplier),
         "x"));
         var purchaseAction = A2($Santa$Controller$Controller.Purchase,
         purchasableProducer,
         purchaseMultiplier);
         var producer = _U.remove("cost",
         purchasableProducer);
         var cost = A3($Santa$Model$Producer.cost,
         purchasableProducer,
         A2($Santa$Model$Stackable.count,
         producer,
         producers),
         ...
         var amount = A2($Basics._op["++"],
         $Basics.toString(A2($Santa$Model$Stackable.count,
         producer,
         producers)),
         "");
         return A2($Html.tr,
         ...
         _L.fromArray([A2($Html.td,
                      ...
                      _L.fromArray([]),
                      _L.fromArray([A2($Html.div,
                      _L.fromArray([$Html$Attributes.$class("tooltip-Περιτύλιγμα")]),
                      _L.fromArray([A2($Html.span,
                                   ...
                                   _L.fromArray([$Html.div(_L.fromArray([]))(A2($List.map,
                                   displayProducerFunction,
                                   producer.function))]))]))]))
                      ,A2($Html.td,
   ...
   unlockables) {
      return function () {
         ...
         ps);
         return $List.isEmpty(ps) ? A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("panel-body")]),
         _L.fromArray([A2($Html.p,
         _L.fromArray([]),
         _L.fromArray([$Html.text("Research to unlock more workshop items!")]))])) : A2($Html.table,
...
Elm.Santa.View.Product.make = function (_elm) {
   ...
   canAfford) {
      return function () {
         var costColor = canAfford ? "#fff" : "#f00";
         return $List.isEmpty(cost) ? $Html.text("") : A2($Html.div,
      ...
      return function () {
         var progressBar = function (pct) {
            return function () {
               ...
               1.0) ? {ctor: "_Tuple2"
                      ,_0: "COMPLETED"
                      ,_1: " progress-bar-success"} : {ctor: "_Tuple2"
                                                      ,_0: A2($Basics._op["++"],
                                                      $Basics.toString($Basics.round(pct * 100)),
                                                      "%")
                                                      ,_1: ""},
               ...
               success = $._1;
               return A2($Html.div,
               _L.fromArray([$Html$Attributes.$class("progress")]),
               _L.fromArray([A2($Html.span,
               _L.fromArray([$Html$Attributes.$class(A2($Basics._op["++"],
                            ...
                            "role",
                            "progressbar")
                            ,$Html$Attributes.stringProperty("aria-valuenow")($Basics.toString(pct * 100))
                            ,A2($Html$Attributes.stringProperty,
                            "aria-valuemin",
                            "0")
                            ,A2($Html$Attributes.stringProperty,
            ...
            return function () {
               ...
               _L.fromArray([A2($Html.td,
                            ...
                            _L.fromArray([A2($Html.span,
                                         ...
                                         ,A2($Html.div,
                                         _L.fromArray([$Html$Attributes.$class("tooltip")]),
                                         _L.fromArray([$Html.div(_L.fromArray([]))($List.intersperse(A2($Html.br,
                                         _L.fromArray([]),
                                         _L.fromArray([])))($List.map($Html.text)($Santa$Model$Unlockable.description(x.bonus))))]))]))]))
                            ,A2($Html.td,
                            _L.fromArray([A2($Html$Attributes.stringProperty,
                            "width",
                            "60%")]),
                            _L.fromArray([progressBar(1 - x.progressTimer / x.progressMax)]))
                            ,A2($Html.td,
                            _L.fromArray([A2($Html$Attributes.stringProperty,
                            "width",
                            "20%")]),
                            ...
                            _L.fromArray([A2($Html.button,
                                         _L.fromArray([$Html$Attributes.$class("btn btn-default trigger")
                                                      ,$Html$Attributes.disabled(_U.cmp(x.progressTimer,
                                                      x.progressMax) < 0 || $Basics.not(canAfford))
                                                      ,$Html$Events.onClick(A2($Signal.send,
                                                      $Santa$Controller$Controller.actionChannel,
   ...
   var display = function (state) {
      ...
      _L.fromArray([A2($Html.header,
                   ...
                   _L.fromArray([A2($Html.div,
                                ...
                                _L.fromArray([A2($Html.div,
                                             ...
                                             _L.fromArray([A2($Html.div,
                                                          ...
                                                          _L.fromArray([A2($Html.div,
                                                                       ...
                                                                       _L.fromArray([$Html.text("Έτοιμα για παράδοση")]))
                                                                       ,A2($Html$Lazy.lazy,
                                                          ...
                                                          _L.fromArray([A2($Html.div,
                                                                       _L.fromArray([$Html$Attributes.$class("panel-heading")]),
                                                                       _L.fromArray([$Html.text("Έτοιμο για συσκευασία")]))
                                                                       ,A2($Html$Lazy.lazy,
                                                          ...
                                                          _L.fromArray([A2($Html.div,
                                                                       _L.fromArray([$Html$Attributes.$class("panel-heading")]),
                                                                       _L.fromArray([$Html.text("Ακατέργαστα προϊόντα")]))
                                                                       ,A2($Html$Lazy.lazy,
                                ...
                                _L.fromArray([$Html$Attributes.$class("row")]),
                                _L.fromArray([A2($Html.div,
                                             _L.fromArray([$Html$Attributes.$class("col-sm-6 text-left")]),
                                             _L.fromArray([$Html.text("Copyright © 2014 Yu He")
                                                          ,$Html.text(" | ")
                                                          ,A2($Html.a,
                                                          _L.fromArray([$Html$Attributes.href("http://www.inconspicuous.no")]),
                                             ...
                                             _L.fromArray([$Santa$View$Changelog.displayVersion
                                                          ...
                                                          _L.fromArray([$Html.text("Source @ GitHub")]))
                                                          ,$Html.text(" | ")
                                                          ...
                                                          ,$Html.text(", ")
                                                          ,A2($Html.a,
                                                          _L.fromArray([$Html$Attributes.href("http://getbootstrap.com/")]),
